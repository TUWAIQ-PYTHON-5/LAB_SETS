nestle_products = {"KitKat" : '34,456,432', 
                    "Nescafe" : '14,106,132' ,
                     "Maggi" : '9,960,312' , 
                     "Nido" : '44,506,003' }

unilever_products = { "Lipton" : '23,456,000' ,
                       "Breyers" : '1,235,891', 
...
top_selling_of_nestle=max(nestle_products)
print(top_selling_of_nestle)
top_selling_of_unilever= max(unilever_products)
print(top_selling_of_unilever)
